...
<html lang="en">
    <head>
        ...
        <meta name="twitter:image" content="https://www.<?php echo $domain; ?>/assets/v1/img/wikitolearn.jpg"/>
        <meta property="og:image" content="https://www.<?php echo $domain; ?>/assets/v1/img/wikitolearn.jpg"/>
