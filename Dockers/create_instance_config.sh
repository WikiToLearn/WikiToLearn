...
if [[ ! -f instance_config.conf ]] ; then
 {
  ...
  echo "export W2L_DOCKER_OCG=wikitolearn/ocg:0.7.2"
  echo "export W2L_DOCKER_WEBSRV=wikitolearn/websrv:0.8.3"
  echo "export W2L_DOCKER_HAPROXY=wikitolearn/haproxy:0.4"
