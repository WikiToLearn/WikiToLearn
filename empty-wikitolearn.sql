...
INSERT INTO `pagelinks` VALUES (10,0,'C++',10),(2,0,'Come_aiutare',0),(2,0,'Dipartimenti',0),(6,0,'Hall_of_fame',0),(9,0,'Main_Page_HSF',10),(10,0,'Main_Page_HSF',10),(2,0,'WikiFM_Stats2',0),(2,0,'WikiFM_Thanks',0),(11,2,'Example',10),(3,10,'Dipartimento',0),(4,10,'Dipartimento',0),(2,10,'WTL_Intro',0),(18,11,'Archive_for_converted_wikitext_talk_page',10);
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=latin1 MAX_ROWS=10000000 AVG_ROW_LENGTH=1024;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `site_stats` VALUES (1,19,0,18,158,0,0);
...
CREATE TABLE `text` (
  ...
  PRIMARY KEY (`old_id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=latin1 MAX_ROWS=10000000 AVG_ROW_LENGTH=10240;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-02-12 11:23:09
